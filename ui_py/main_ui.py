...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.input_start_point_x = QLineEdit(self.layoutWidget)
        self.input_start_point_x.setObjectName(u"input_start_point_x")
        self.input_start_point_x.setMaxLength(32767)

        self.horizontalLayout_2.addWidget(self.input_start_point_x)

        self.input_start_point_y = QLineEdit(self.layoutWidget)
        self.input_start_point_y.setObjectName(u"input_start_point_y")

        self.horizontalLayout_2.addWidget(self.input_start_point_y)

        self.input_end_point_x = QLineEdit(self.layoutWidget)
        self.input_end_point_x.setObjectName(u"input_end_point_x")

        self.horizontalLayout_2.addWidget(self.input_end_point_x)

        self.input_end_point_y = QLineEdit(self.layoutWidget)
        self.input_end_point_y.setObjectName(u"input_end_point_y")

        self.horizontalLayout_2.addWidget(self.input_end_point_y)
