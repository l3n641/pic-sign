...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.input_match_distance_thresh.setGeometry(QRect(470, 30, 51, 20))
        self.layoutWidget = QWidget(self.groupBox_2)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(20, 90, 544, 27))
        self.horizontalLayout_2 = QHBoxLayout(self.layoutWidget)
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.input_point_x = QLineEdit(self.layoutWidget)
        self.input_point_x.setObjectName(u"input_point_x")
        self.input_point_x.setMaxLength(32767)

        self.horizontalLayout_2.addWidget(self.input_point_x)

        self.input_point_y = QLineEdit(self.layoutWidget)
        self.input_point_y.setObjectName(u"input_point_y")

        self.horizontalLayout_2.addWidget(self.input_point_y)

        self.input_rect_length = QLineEdit(self.layoutWidget)
        self.input_rect_length.setObjectName(u"input_rect_length")

        self.horizontalLayout_2.addWidget(self.input_rect_length)

        self.input_rect_width = QLineEdit(self.layoutWidget)
        self.input_rect_width.setObjectName(u"input_rect_width")

        self.horizontalLayout_2.addWidget(self.input_rect_width)

        self.button_del_rect = QPushButton(self.groupBox_2)
        self.button_del_rect.setObjectName(u"button_del_rect")
        self.button_del_rect.setGeometry(QRect(680, 90, 83, 26))
        self.label_5 = QLabel(self.groupBox_2)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(540, 30, 111, 16))
        ...
        self.input_similarity_thresh.setGeometry(QRect(670, 30, 51, 20))
    ...
    def retranslateUi(self, Widget):
        ...
        self.button_add_rect.setText(QCoreApplication.translate("Widget", u"\u6dfb\u52a0\u70b9\u4f4d", None))
        ...
        self.input_point_x.setInputMask("")
        self.input_point_x.setText("")
        self.input_point_x.setPlaceholderText(QCoreApplication.translate("Widget", u"x\u8f74", None))
        self.input_point_y.setPlaceholderText(QCoreApplication.translate("Widget", u"y\u8f74", None))
        self.input_rect_length.setPlaceholderText(QCoreApplication.translate("Widget", u"\u957f\u5ea6", None))
        self.input_rect_width.setInputMask("")
        self.input_rect_width.setPlaceholderText(QCoreApplication.translate("Widget", u"\u5bbd\u5ea6", None))
